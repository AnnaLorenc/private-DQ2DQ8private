...
Solution: to prepare the input file for testing from imgt_wide_to_properties.py, from results/imgt_aa_combined/comb_aa_imgt_subs_rows.tsv.
Then the annotation is added with properties_add_annotation.py.
