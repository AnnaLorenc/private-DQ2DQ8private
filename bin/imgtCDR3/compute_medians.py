...
Description:
This script computes the median values for subsample counts (=cells) and rows(=unique TRBs), as well as their frequency versions, from a given input file. The user can specify index columns to include in the output, with default columns being 'aminoAcid_length', 'AA', and 'IMGT_position'.
